...
import com.stormkid.oktool.core.OkCallback
import com.stormkid.oktool.core.OkHttpClientBuilder
import com.stormkid.oktool.rule.CallbackRule
import com.stormkid.oktool.rule.ClientRule
import com.stormkid.oktool.rule.DownLoadRule
import com.stormkid.oktool.rule.ProGressRule
import com.stormkid.oktool.utils.CallbackNeed
import com.stormkid.oktool.utils.FileCallbackNeed
import com.stormkid.oktool.utils.FileResponseBody
...
//                val resultBody = FileResuestBody(multipartBody,call)
        ...
        fun downLoad(context: Context, proGressRule: ProGressRule) {
            ...
            getFactoryClient().newBuilder().addNetworkInterceptor { chain ->
                ...
                com.stormkid.oktool.asyc.DownloadManager(
                    fileCallbackNeed,
                    proGressRule
                )
            )
